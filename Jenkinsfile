...
*/
def ZOWE_CLI_BUNDLE_VERSION = "1.12.0"
def ZOWE_VERSION_NUMBER = "1.12.0"
...
* Zowe 1.0.0 licenses
*/
def ZOWE_LICENSE_ZIP_PATH = "/org/zowe/licenses/1.12.0/zowe_licenses_full.zip"
...
* Master branch
*/
def MASTER_BRANCH = "v1.12.0/master"
        ...
        stage('Create Zowe CLI Plugins Bundle') {
            ...
            steps {
                timeout(time: 10, unit: 'MINUTES') {
                    ...
                    sh "npm pack @zowe/db2-for-zowe-cli@4.0.2"
                    sh "npm pack @zowe/cics-for-zowe-cli@4.0.6"
