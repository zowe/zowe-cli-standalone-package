...
*/
def ZOWE_CLI_BUNDLE_VERSION = "1.16.0"
...
* Zowe 1.0.0 licenses
*/
def ZOWE_LICENSE_ZIP_PATH = "/org/zowe/licenses/1.16.0/zowe_licenses_full.zip"
...
* Master branch
*/
def MASTER_BRANCH = "v1.16.0/master"
