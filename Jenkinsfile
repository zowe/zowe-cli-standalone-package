...
*/
def ZOWE_CLI_BUNDLE_VERSION = "1.15.0"
def ZOWE_VERSION_NUMBER = "1.15.0"
...
* Zowe 1.0.0 licenses
*/
def ZOWE_LICENSE_ZIP_PATH = "/org/zowe/licenses/1.15.0/zowe_licenses_full.zip"
...
* Master branch
*/
def MASTER_BRANCH = "v1.15.0/master"
        ...
        stage('Create Zowe CLI Bundle') {
            ...
            steps {
                timeout(time: 10, unit: 'MINUTES') {
                    ...
                    sh "npm pack @zowe/cli@6.22.0"
                    sh "npm pack @zowe/secure-credential-store-for-zowe-cli@4.1.0"
        ...
        stage('Create Zowe CLI Plugins Bundle') {
            ...
            steps {
                timeout(time: 10, unit: 'MINUTES') {
                    ...
                    sh "npm pack @zowe/db2-for-zowe-cli@4.0.6"
